...
import { keyboardDistributionLog } from '../data/dummyData';
...
export const KeyboardLog: React.FC = () => {
    const [logs, setLogs] = useLocalStorage<PeripheralLogEntry[]>('keyboardLogs', keyboardDistributionLog);
        ...
        <>
            <div className="bg-white p-6 rounded-xl shadow-lg">
                 <div className="flex flex-col md:flex-row justify-between md:items-center mb-4 gap-4">
                    <h1 className="text-2xl font-bold text-gray-800">Keyboard Service Log</h1>
