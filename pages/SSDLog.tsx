...
import { ssdDistributionLog } from '../data/dummyData';
...
export const SSDLog: React.FC = () => {
    const [logs, setLogs] = useLocalStorage<PeripheralLogEntry[]>('ssdLogs', ssdDistributionLog);
    ...
    const handleExport = () => {
        exportToCSV(filteredLogs, 'ssd-service-logs');
    };
